                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mb-2 mb-lg-0 navbar-nav_bar">
                            <li className="nav-item">
                                <a className="nav-link active create_post" aria-current="page" href="./pages/create.html">Create Post</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link action" href="./pages/notification.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <span className="avatar_bar">
                                        <img className="avatar_image" alt="" id="nav-profile-image" src="/img/people11.png"/>
                                    </span>
                                </a>
        ...
        <div className="container-fluid" id="banner">
            <div className="row justify-content-center">
                <div className="col-xxl-10 col-xl-11 col-lg-11 col-md-12 banner">
                    <div className="row justify-content-center">
                        <button className="closebutton" id="js-hero-banner__x" aria-label="Close campaign banner">×</button>
                        <div className="col-lg-8 col-md-12 col-sm-12 campaing">
                            <div className="banner_top">
                                <div className="campaign_banner">
                                    <h4>Join us at</h4>
                                    <img height="193" width="420" className="campaignmode-hackathon--mainimage"
                                    ...
                                    <h2>The community-first coding conference designed to level you up! Sep 23-24 🌈
                                    </h2>
                ...
                <div className="col-lg-3 col-md-2" id="lsBar">
                        ...
                        <ul className="nav nav-pills flex-column">
                            <li className="nav-item">
                                <div className="nav-link" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24"
                                        aria-hidden="true" className="crayons-icon crayons-icon--default" id="LBicon1">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="./pages/notification.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24"
                                        aria-hidden="true" className="crayons-icon crayons-icon--default" id="LBicon2">
                                        <g className="nc-icon-wrapper">
                                            <path fill="#EF9645"
                            ...
                            <li className="nav-item">
                                <a className="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24"
                                        aria-hidden="true" className="crayons-icon crayons-icon--default" id="LBicon3">
                                        <g className="nc-icon-wrapper">
                                            <path fill="#EF9645"
                                                d="M21 22s-6.031 5.274-7.74 6.832c-1.323 1.203.88 3.498 2.135 2.452 3.333-2.785 6.493-4.85 6.493-4.85l.367.526c-1.309.79-4.693 2.858-6.449 4.438-1.324 1.19.767 3.553 2.093 2.365 1.822-1.634 5.995-4.565 5.995-4.565l.368.384c-1.08.679-2.772 1.94-4.985 3.958-1.332 1.215.619 2.485 1.764 1.534 3.116-2.586 3.232-4.383 6.661-5.85C32.935 26.986 21 22 21 22z">
                                            </path>
                                ...
                                <a className="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24"
                                        ...
                                        <g className="nc-icon-wrapper">
                                            ...
                                            <path fill="#DD2E44"
                                                d="M5 12l2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2v23H5z"></path>
                                            <path fill="#FFCC4D"
                                                d="M29 9a8 8 0 00-8 8v8h2v-8a6 6 0 0112 0v8h2v-8a8 8 0 00-8-8z"></path>
                                            <path fill="#744EAA"
                                                d="M19 17l2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2v23H19z"></path>
                                        </g>
                                    </svg>
                            ...
                            <li className="nav-item">
                                <a className="nav-link">
                                    <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" className="rainbow-logo"
                                        width="24" height="24" preserveAspectRatio="xMinYMin meet" id="LBicon10">
                                        <g fill="none" fillRule="evenodd">
                                            ...
                                            <path fill="#FEE18A" fillRule="nonzero"
                                                d="M39.21.95L.04 31.11v35.9L85.84.95z"></path>
                                            <path fill="#F3F095" fillRule="nonzero"
                                                d="M85.84.95L.04 67.01v36.5L133.25.95z"></path>
                                            <path fill="#55C1AE" fillRule="nonzero"
                                                d="M133.27.95L.04 103.53v35.59L179.49.95z"></path>
                                            <path fill="#F7B3CE" fillRule="nonzero"
                                                d="M234.04.95h-7.37L.04 175.45v35.93l234-180.18z"></path>
                                            <path fill="#88AEDC" fillRule="nonzero"
                                                d="M179.49.95L.04 139.12v36.33L226.67.95z"></path>
                                            <path fill="#F58F8E" fillRule="nonzero"
                                            ...
                                            <path fill="#F7B3CE" fillRule="nonzero"
                                                d="M234.04 212l-28.51 21.95h28.51z"></path>
                                            <path
                    ...
                    <div className="LBcontRedS">
                        <div className="btn-group d-flex" role="group" aria-label="Basic example">
                            <div className="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" color="#efefef;" width="24" height="24"
                                    viewBox="0 0 24 24" role="img" aria-labelledby="ai4pdf64bypf8q80ywn553hvgqbrl1jp"
                                    id="LBiconRS1" className="crayons-icon">
                                    <title>Twitter</title>
                                    <path
                            ...
                            <div className="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    role="img" aria-labelledby="amdtg958ehcf4servl7s3trcpskvnoki" className="crayons-icon"
                                    id="LBiconRS2">
                            ...
                            <div className="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    role="img" aria-labelledby="abf06n84py7jjo9xf3s959qj9bv1w4l0" className="crayons-icon"
                                    id="LBiconRS3">
                                    <title>Github</title>
                                    <path
                            ...
                            <div className="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    role="img" aria-labelledby="a840zosj3uvz7e41xbf70nom69z3k0ox" className="crayons-icon"
                                    id="LBiconRS4">
                            ...
                            <div className="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    role="img" aria-labelledby="aku177oz4ckizrnc4xhuqlxpugrj8y27" className="crayons-icon"
                                    id="LBiconRS5">
                                    <title>Twitch</title>
                                    <path
                    ...
                    <div className="LBcontTags">
                        <div className="contHeadTags">
                            <div className="LBheadTags">
                                My Tags
                            </div>
                            <a id="tag-priority-link" href="/dashboard/following_tags"
                                className="crayons-btn crayons-btn--icon crayons-btn--ghost-dimmed"
                                aria-label="Customize tag priority" title="Customize tag priority">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    className="crayons-icon">
                                    <path
                    ...
                    <div className="LBcontPub">
                        <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--Th3frs95--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_350/https://thepracticaldev.s3.amazonaws.com/i/a7tz6hpmtwmgx2pe2ch2.jpg"
                ...
                <div className="col-lg-6 col-md-6 col-sm-10 main__body">
                    <nav className="d-flex justify-content-between ">
                        <ul className="d-flex ms-3">
                            <li><a href="#" className="li-select me-3 text-dark headFilter headSelected" id="feed">Feed</a></li>
                            <li><a href="#" className="me-3 text-dark headFilter" id="latest">Latest</a></li>
                            <li><a href="#" className="text-dark headFilter" id="top">Top</a></li>
                        </ul>
                        <ul className="d-flex ms-3 topLinked">
                            <li><a href="#" className="li-select me-3 text-dark headFilterByTime headSelected" id="week">Week</a></li>
                            <li><a href="#" className="me-3 text-dark headFilterByTime" id="month">Month</a></li>
                            <li><a href="#" className="text-dark headFilterByTime" id="year">Year</a></li>
                        </ul>
                    </nav>
                        ...
                        <article className="authentication__body">
                            <div className="feed__container">
                                ...
                                <div className="feed__title">
                                    <h2><a href="">DEV Community</a> is a community of 696,623 amazing developers
                                    </h2>
                                    <p>We're a place where coders share, stay up-to-date and grow their careers.</p>
                                </div>
                            </div>
                            <div className="feed__actions">
                                <a href="#" className="btn btn-blue">Create new account</a>
                                <a href="#" className="btn btn-transparent">Log in</a>
                            </div>
                        </article>
                    </section>

                    <h1>Aquí van las cards en components</h1>
                    ...
                    <div className="row">
                        <div className="col-12">
                                    ...
                                    <p>
                                        <a
                                            ...
                                            <img className="image_ar"
                                                ...
                                                alt="The logo for the DevDiscuss podcast." loading="lazy"/>
                                        </a>
                                    </p>
                                    <h4>
                                        Listen to DevDiscuss S6E6! 🎧
                                    </h4>
                                    <p>
                                ...
                                <div className="p-3 card_g_ar">
                                    ...
                                    <div>
                                        ...
                                        <a className="card_link_ar"
                                            ...
                                            <div className="primer_ar">The Future of HTML Controls - Free Session - Sep 23, 1pm ET (GMT -4)
                                            </div>
                                            <div className="card_link_secon_ar">events</div>
                                        </a>
                                        <a className="card_link_ar" href="/listings/events/top-devternity-conference-2ebo">
                                            <div className="primer_ar">❗ ATTENTION ❗ DevTernity is coming!</div>
                                            <div className="card_link_secon_ar">events</div>
                                        </a>
                                        <a id="final_link" href="/listings/new">Create a Listing</a>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="p-3 card_g_ar">
                                    <header className="crayons-card__header">
                                        <h3 className="subtitle_ar">
                                            <a href="/t/news" className="link_sub">#news</a>
                                        </h3>
                                    </header>
                                    <div>
                                        <a className="card_link_ar"
                                        ...
                                        <a className="card_link_ar" href="/dgbarreto/mudanca-de-privacidade-chegando-k0g">
                                            Mudança de Privacidade Chegando
                                            <div className="card_link_secon_ar">
                                                <span className="indicator-ar">
                                                    New
                                                </span>
                                            </div>
                                        </a>
                                        <a className="card_link_ar"
                                            ...
                                            Save your application from crashing by wrong use of Web Storage API or
                            ...
                            <div className="row">
                                <div className="p-3 card_g_ar">
                                    <header className="crayons-card__header">
                                        <h3 className="subtitle_ar"><a href="/t/help" className="link_sub">#help</a>
                                        </h3>
                                    </header>
                                    <div>
                                        <a className="card_link_ar" href="/robins/hello-world-gaf">
                                            Hello, World!
                                            <div className="card_link_secon_ar">
                                        ...
                                        <a className="card_link_ar" href="/esaldivar/how-to-write-a-readme-3ge9">
